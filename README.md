# All Restaurants in Detroit, Michigan, US

> Free BeamStation sample export with 192 rows and masked direct-contact fields.
...
| Full dataset size | 1,924 records |
| Free sample size | 192 records (9.98%) |
| Last export | 2026-04-16T20:58:21.555723+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-detroit-michigan-us-sample-208407/releases/download/sample-latest/beamstation_208407_restaurants-us-mi_SAMPLE_DIST.csv) |
...
Search for dataset ID `208407` on BeamStation if you want the exact commercial listing.
